...
class RDP_WIKI_EMBED_SHORTCODE_POPUP {
    ...
    public static function renderPopupForm(){
        ...
        $value = intval($value);        
        echo '<input type="checkbox" aria-required="true" class="rdp_we_setting" value="1" id="rdp_we_title_show" ' . checked( $value , 1, false) . ' /> <span style="margin-right: 8px;"><label for="rdp_we_title_show"> ';
        _e('Display title', 'rdp-wiki-embed');
        echo '</label></span>';
        echo '</tr>';        
