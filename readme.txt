...
**RDP Wiki Embed is not coded to work with the block editor.  Therefore, the shortcode button will not work.** A plugin that restores the classic editor will need to be installed for the shortcode button to work. Get the Classic Editor Plugin [here.](https://wordpress.org/plugins/classic-editor/)
...
= 1.2.17 =
* Added an option to the plugin setting page to hide or show the title on every fetched wiki page
* Added an option to the plugin setting page to hide elements on all fetched pages
